...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val nairobi = LatLng(-1.2686118, 36.8473969)
        ...
        val kehancha = LatLng(-1.1954058, 34.6184348)
        mMap.addMarker(MarkerOptions().position(kehancha).title("Marker in kisii"))
        mMap.moveCamera(CameraUpdateFactory.newLatLng(kehancha))
    }
}